...
// extract data
exports.extractData = (lifelines, messages, fragments) => {
...
// func to PVs
exports.paramterValuesMapping = (messages, fragments) => {
  // main logic
  var k = 0;
...
exports.checkGuardCondition = (fragments) => {
...
exports.extractGuardConditions = (fragments) => {
...
const fillPVMatrix = (finalConfig) => {
  ...
  for (let i = 0; i < finalConfig.length; i++) {
    ...
    PVMatrix[0][i] = String(p);
    for (var j = 1; j <= v.length; j++) {
      PVMatrix[j][i] = String(v[j - 1]);
    }
  }
